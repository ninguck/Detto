    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background border-b-2 border-border">
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-4">
          <div className="bg-background border-2 border-border rounded-md flex items-center gap-2 px-3 py-2">
          ...
          {/* Current streak */}
          <div className="bg-yellow-500 border-2 border-border rounded-md flex items-center gap-2 px-3 py-2">
            <Flame className="h-4 w-4 text-primary-foreground" />
            <span className="font-black text-primary-foreground text-lg font-sans">{currentStreak}</span>
          </div>

          <div className="bg-red-500 border-2 border-border rounded-md  flex items-center gap-2 px-3 py-2">
